    ...
    <>
      ...
      >
        <a
          href={siteLink}
          target="_blank"
          className="interactable flex w-[890px] cursor-pointer items-center text-[26px] text-dennisDark duration-300 hover:ml-[-20px] hover:text-neutral-500/50 sm:text-[5vw]"
        >
          <p>{name}</p>
        </a>
...
// https://dalforno.netlify.app
// https://energym-fit.netlify.app
